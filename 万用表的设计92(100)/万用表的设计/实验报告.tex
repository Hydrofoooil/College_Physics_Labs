...
\section{预习报告}
    ...
    \begin{figure}[htbp]
        ...
        \begin{subfigure}[t]{0.45\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{改装电流表1.png}
            \label{fig:current_meter1}
        \end{subfigure}
        \begin{subfigure}[t]{0.45\textwidth}
            \centering
            \includegraphics[width=0.8\textwidth]{改装电流表2.png}
    ...
    \begin{figure}[htbp]
        ...
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=1.1\textwidth]{改装电压表1.png}
            \label{fig:current_meter1}
        \end{subfigure}
        \begin{subfigure}[t]{0.45\textwidth}
            \centering
            \includegraphics[width=0.7\textwidth]{改装电压表2.png}
            \label{fig:current_meter2}
        \end{subfigure}
        \caption{改装电路表电路图}
        \label{fig:图1}
    ...
    \begin{wrapfigure}{r}{0.4\textwidth}
        ...
        \centering
        \includegraphics[width=0.5\textwidth]{改装欧姆表.png}
        \caption{欧姆表校准电路图}
...
\begin{figure}[htbp]
    \centering    
        \includegraphics[width=0.9\textwidth]{linear_fit_chart1.jpg}
    \label{fig:图1}
\end{figure}
...
\begin{figure}[htbp]
    \centering    
        \includegraphics[width=0.9\textwidth]{linear_fit_chart2.jpg}
    \label{fig:图1}
\end{figure}
...
\begin{figure}[htbp]
    \centering    
        \includegraphics[width=0.9\textwidth]{nonlinear_fit_chart.jpg}
    \label{fig:图1}
\end{figure}
